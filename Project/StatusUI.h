...
private:
	...
	static constexpr VEC2D DEF_IMAGE_POS = { 10,210 };//防御力アイコンの画像を描画する座標
	static constexpr VEC2D AGI_IMAGE_POS = { 10,280 };//素早さアイコンの画像を描画する座標
	static constexpr VEC2D ATK_TEXT_POS	 = { 60,140  };//攻撃力アイコン用テキストを描画する座標
	static constexpr VEC2D DEF_TEXT_POS  = { 60,210 };//防御力アイコン用テキストを描画する座標
	static constexpr VEC2D AGI_TEXT_POS  = { 60,280 };//素早さアイコン用テキストを描画する座標
